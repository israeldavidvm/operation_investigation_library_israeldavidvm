...
x3= LpVariable("Numero_de_autos",0) 

prob += 8*x1+3*x2+2*x3, "Ingresos totales"

prob+=1*x1+3*x2+1*x3<=430, "restriciones_tiempo_operacion_1"
prob+=2*x1+0*x2+4*x3<=460, "restriciones_tiempo_operacion_2"
prob+=1*x1+2*x2+0*x3<=420, "restriciones_tiempo_operacion_3"
